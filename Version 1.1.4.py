...
def start_c():
    ...
    def levels_s():
        ...
        #Medium button
        Medium_img = Image.open(r"C:\Users\24705\OneDrive - Lynfield College\3PAD\Assessment 91906 and 91907\Checkpoit 1\IMAGES\medium_lvl.png")
        ...
        Medium_btn.place(relx=0.22, rely=0.6, anchor="center")

        #Hard button
        Hard_img = Image.open(r"C:\Users\24705\OneDrive - Lynfield College\3PAD\Assessment 91906 and 91907\Checkpoit 1\IMAGES\hard_lvl.png")
        Hard_img = Hard_img.resize((250, 80), Image.Resampling.LANCZOS) 
        Hard_photo = ImageTk.PhotoImage(Hard_img)

        Hard_btn = tk.Button(levels_w, image=Hard_photo, borderwidth=0, command=root_quit)
        Hard_btn.image = Hard_photo  
        Hard_btn.place(relx=0.62, rely=0.6, anchor="center")
